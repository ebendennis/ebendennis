...
map.on('load', function() {
    ...
    geocoder.on('result', function(ev) {
      ...
      if (isInside != true) {
        ...
        $('#content').empty();
        $('#content').append("<h5 class='mdl-dialog__title'>This property is within the 100-year floodplain</h5><div class='mdl-dialog__content'><p>If you have a federally backed mortgage, you are required to obtain flood insurance.</p><p>The information below can help you find out what you need to know in order to:<ol><li><a href='#insurance'>Purchase flood insurance</a></li><li><a href='#letter'>Submit a letter of map revision in order to contest your home's location within the floodplain</a></li><li><a href='#certificate'>Potentially reduce insurance costs by obtaining an elevation certificate</a></li></ol></p><h5><a name='insurance'>Flood Insurance:</a></h5><p>You can purchase insurance from a licensed private insurance company or an independent property and casualty insurance agent. This is usually your homeowner's insurance agent. Any local insurance agent can sell an insurance policy and legally must charge the same rate.</p><p>To find a qualified agent, call toll-free at 1-888-379-9531 or visit <a href='http://www.floodsmart.gov' target='_blank'>www.floodsmart.gov</a> and then select 'Agent Locator' under 'Resources.'</p><p>When purchasing flood insurance, the insurance agent may ask for an Elevation Certificate or Floodproofing Certificate. These certificates identify protection measures that may have been incorporated into the buildings construction and are used to determine the annual premium costs for an insurance policy.</p><h5><a name='letter'>Letter of Map Revision</a></h5><p>If your structure is elevated or if your property was incorrectly mapped in the regulated floodplain, you may request that it be removed from the floodplain. Contact a licensed land surveyor to determine if your property qualifies for a Letter of Map Amendment to potentially remove your property from the floodplain. Although Boulder’s floodplain mitigation and regulation is aligned with a 100-year flood, that doesn’t mean flooding can’t happen outside of the floodplain at any time.</p><h5><a name='certificate'>Elevation Certificates:</a></h5><p>Only Elevation Certificates apply to residential structures, since FEMA does not recognize floodproofing measures for residential construction. If the lowest floor of a dwelling and its associated structures are located above the 100-year flood elevation, insurance premium costs are reduced. For new residential construction in Boulder, the lowest floor and associated structures must be constructed a minimum of two feet above the 100-year flood elevation.</p><p>Elevation Certificates must be prepared and certified by a Colorado-registered professional land surveyor.</p></div>");};
    });
});
